...
const MethodologySection = () => {
  ...
  const appData = [
    ...
    { name: 'Instagram', count: 15420, filtered: true },
    { name: 'Gmail', count: 14898, filtered: true },
    { name: 'Contacts', count: 13543, filtered: true },
    { name: 'Telegram', count: 10733, filtered: true },
    { name: 'Slidejoy', count: 9033, filtered: true },
    { name: 'Settings', count: 8689, filtered: true },
    { name: 'Verizon Messages', count: 8338, filtered: true },
    { name: 'YouTube', count: 7526, filtered: true },
    { name: 'Phone', count: 7376, filtered: true },
    { name: 'Twitter', count: 6928, filtered: true },
    { name: 'WhatsApp Messenger', count: 6655, filtered: true },
    { name: 'Google Play Store', count: 6570, filtered: true },
    { name: 'Android In Call UI', count: 5840, filtered: true },
    { name: 'Samsung Internet Browser', count: 5704, filtered: true },
    { name: 'Messaging', count: 5700, filtered: true },
    { name: 'Samsung Gallery', count: 5394, filtered: true },
    { name: 'Telegram X', count: 4650, filtered: true },
    { name: 'Camera', count: 4501, filtered: true },
    { name: 'Reddit', count: 4440, filtered: true },
    { name: 'Maps', count: 4171, filtered: true },
    { name: 'Hangouts', count: 3277, filtered: true },
    { name: 'S\'more', count: 2993, filtered: true },
    { name: 'Samsung Email', count: 2578, filtered: true },
    { name: 'Snapchat', count: 2529, filtered: true },
    { name: 'Samsung Pay', count: 2467, filtered: true },
    { name: 'Faceu', count: 2297, filtered: true },
    { name: 'DigiHUD Pro Speedometer', count: 2290, filtered: true },
    { name: 'MAX Cleaner', count: 2206, filtered: true },
    { name: 'Reward Stash', count: 1968, filtered: true },
    { name: 'Google Drive', count: 1925, filtered: true },
    { name: 'MetroZone', count: 1799, filtered: true },
    { name: 'WeChat', count: 1755, filtered: true },
    ...
    { name: 'Calculator', count: 1395, filtered: true },
    { name: 'Microsoft Outlook', count: 1305, filtered: true },
    { name: 'Amazon Shopping', count: 1302, filtered: true },
    { name: 'SurveyCow', count: 1252, filtered: true },
    { name: 'Google Photos', count: 1179, filtered: true },
    { name: 'imo', count: 1099, filtered: true },
    { name: 'Pinterest', count: 947, filtered: true },
    { name: 'Google Play Music', count: 919, filtered: true },
    ...
    { name: 'Podcast Addict', count: 653, filtered: true },
    { name: 'MUIQ Survey App', count: 651, filtered: true },
    { name: 'Clean Master', count: 550, filtered: true },
    { name: 'Quora', count: 530, filtered: true },
    { name: 'Walmart', count: 497, filtered: true },
    { name: 'Words With Friends 2', count: 489, filtered: true },
    { name: 'Hulu', count: 471, filtered: true },
    { name: 'Movie Play Box', count: 452, filtered: true },
    { name: 'Robinhood', count: 426, filtered: true },
    { name: 'PayPal Mobile Cash', count: 392, filtered: true },
    { name: 'The PCH App', count: 384, filtered: true },
    { name: 'Messenger Lite', count: 336, filtered: true },
    { name: 'Samsung Notes', count: 335, filtered: true },
    { name: 'Army Men Strike', count: 307, filtered: true },
    { name: 'Swagbucks', count: 307, filtered: true },
    { name: 'Lucktastic', count: 288, filtered: true },
    { name: 'OfferUp', count: 241, filtered: true },
    { name: 'Calorie Counter', count: 199, filtered: true },
    { name: 'Receipt Hog', count: 197, filtered: true },
    { name: 'Minesweeper Classic (Mines)', count: 174, filtered: true },
    { name: 'Flipboard Briefing', count: 130, filtered: true },
    { name: 'Baseball Boy!', count: 124, filtered: true },
    { name: 'TextNow', count: 119, filtered: true },
    { name: 'Ibotta', count: 118, filtered: true },
    { name: 'Badoo', count: 110, filtered: true },
    { name: 'Swagbucks Watch (TV)', count: 101, filtered: true },
    ...
    { name: 'Flickr', count: 1, filtered: false }
  ];
